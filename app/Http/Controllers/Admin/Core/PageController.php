...
class PageController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $data->slug = Helper::check_slug($table_page, $slug);
            ...
            if ($request->file($form_element_name)) {
                ...
                $allowed_extensions = ['jpeg', 'jpg', 'png', 'gif', 'webp', 'avif'];
            ...
            if ($request->$form_element_name) {
                ...
                $summary = $data->$form_element_name;
            }
                ...
                foreach ($v_page_element_type[$key] as $key2 => $value2) {
                    ...
                    switch ($value2) {
                        ...
                        default:
                            return back()
                                ->withInput()
                                ->with('error', lang('Oops, there is an unknown content element type', $this->translations));
                            break;
                    }
