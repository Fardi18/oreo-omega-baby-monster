...
class BannerController extends Controller
{
    ...
    public function index($position)
    {
        ...
        return view('admin.core.banner.list', compact('position'));
    }
    ...
    public function create($position)
    {
        ...
        return view('admin.core.banner.form', compact('position'));
    }
    ...
    public function store($position, Request $request)
    {
        ...
        try {
            ...
            $data->title_text = Helper::validate_input_text($request->title_text);
            $data->subtitle_text = Helper::validate_input_text($request->subtitle_text);
            $data->btn_label = Helper::validate_input_text($request->btn_label);
    ...
    public function edit($position, $id, Request $request)
    {
        ...
        return view('admin.core.banner.form', compact('data', 'raw_id', 'position'));
    }
    ...
    public function deleted_data($position)
    {
        ...
        return view('admin.core.banner.list', compact('deleted_data', 'position'));
    }
    ...
    public function get_deleted_data($position, Datatables $datatables, Request $request)
    {
        ...
        return $datatables->eloquent($query)
            ...
            ->addColumn('image_show', function ($data) {
                return '<a href="' . asset($data->image) . '" target="_blank"><img src="' . asset($data->image_thumb) . '" style="max-width:200px; max-height:200px;"></a>';
            })
