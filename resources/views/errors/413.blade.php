@php
    ...
    if ($global_config->bg_images) {
        ...
        if (isset($bg_images_existing['413'])) {
            $bg_img = $bg_images_existing['413'];
        }
    }
@endphp
...
<head>
    ...
    <title>413 ({{ ucwords(lang("request entity too large")) }}) | {!! $global_config->meta_title !!}</title>
    ...
    @if (isset($global_config->og_type))
        ...
        <meta property="og:title" content="413 ({{ ucwords(lang("request entity too large")) }}) | {!! $global_config->og_title !!}" />
...
<body class="{{ $preview_class }}">
    ...
    <div class='container'>
      <div class='row content'>
        ...
        <div class='col-lg-12'>
          <h1>413</h1>
          <h2 style="width: 100%">{{ ucwords(lang("request entity too large")) }} (MAX {{ ini_get('post_max_size') }})</h2>
          <h2 style="width: 100%">{{ lang("Try to reduce your file size before re-submit it") }}</h2>
          <p>
