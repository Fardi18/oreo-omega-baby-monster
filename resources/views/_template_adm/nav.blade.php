...
<div class="top_nav">
    <div class="nav_menu">
        <img id="nav_logo" src="{{ asset($global_config->app_logo) }}" style="display:none;"/>
        <nav>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="">
                    <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                        <img id="admin_img" src="{{ Helper::get_avatar() }}" alt=""><span class="admin_name">{{ Session::get(env('SESSION_ADMIN_NAME', 'sysadmin'))->fullname }}</span>
