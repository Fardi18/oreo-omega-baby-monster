                    ...
                    <div class="x_content">
                        ...
                        <form id="form_data" class="form-horizontal form-label-left" action="{{ $link }}" method="POST" enctype="multipart/form-data">
                            ...
                            @php
                                ...
                                $config = new \stdClass();
                                $config->placeholder = 'textarea with limit_chars';
                                $config->limit_chars = 10;
                                echo set_input_form('textarea', 'textarea5', ucwords(lang('textarea', $translations)), $data, $errors, true, $config);
                            ...
                            @php
                                ...
                                $config = new \stdClass();
                                $config->model = 'no button';
                                $config->info = '<i class="fa fa-info-circle"></i> With model="no button", the input file is hidden and "required" status is not running in this model so it is necessary to do manual validation for it.';
                                echo set_input_form('image', 'image_no_btn', ucwords(lang('image', $translations)), $data, $errors, false, $config);
                                ...
                                $config = new \stdClass();
                                $config->total_items = 6;
                                $config->info = '<i class="fa fa-info-circle"></i> This is quite complicated, there is no best practice yet.';
                                echo set_input_form('multiple_images', 'images', ucwords(lang('multiple image(s)', $translations)), $data, $errors, false, $config);
                            @endphp
