...
@section('script')
    ...
    <script>
        // KINIDI Tech - PageBuilder (Form) - Config (BEGIN)
        ...
        var pagebuilder_form_response_wording = false;
        ...
        var pagebuilder_form_question_media = true;
        ...
        // KINIDI Tech - PageBuilder (Form) - Config (END)
