        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <form id="form_data" class="form-horizontal form-label-left" action="{{ $link }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            <h2 onclick="$('#btn-collapse-untranslated').click()" style="cursor: pointer">{{ ucwords(lang('untranslated phrases', $translations)) }}</h2>
                            <ul class="nav navbar-right panel_toolbox">
                                <li style="float: right !important;"><a class="collapse-link" id="btn-collapse-untranslated"><i class="fa fa-chevron-up"></i></a></li>
                            </ul>
                            <div class="clearfix"></div>
                        </div>
                        <div class="x_content">
                            @php
                                // show untranslated phrases
                                if(isset($phrases[0])){
                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            <h2 onclick="$('#btn-collapse-translated').click()" style="cursor: pointer">{{ ucwords(lang('translated phrases', $translations)) }}</h2>
                            <ul class="nav navbar-right panel_toolbox">
                                <li style="float: right !important;"><a class="collapse-link" id="btn-collapse-translated"><i class="fa fa-chevron-down"></i></a></li>
                            </ul>
                            <div class="clearfix"></div>
                        </div>
                        <div class="x_content" style="display: none;">
                            @php
                                // show translated phrases
                                if(isset($phrases[0])){
                                    foreach ($phrases as $item) {
                                        if(isset($translation_data[$item->content])){
