                    ...
                    <div class="x_content">
                        ...
                        <form id="form_data" class="form-horizontal form-label-left" action="{{ $link }}" method="POST" enctype="multipart/form-data">
                            ...
                            @php
                                ...
                                $config->placeholder = 'New Arrivals';
                                echo set_input_form('textarea', 'title_text', ucwords(lang('title text', $translations)), $data, $errors, false, $config);

                                $config = new \stdClass();
                                $config->attributes = 'autocomplete="off"';
                                $config->placeholder = 'Topsale Collection';
                                echo set_input_form('text', 'subtitle_text', ucwords(lang('subtitle text', $translations)), $data, $errors, false, $config);
                                $config->placeholder = 'SHOP NOW';
                                echo set_input_form('text', 'btn_label', ucwords(lang('button label', $translations)), $data, $errors, false, $config);
