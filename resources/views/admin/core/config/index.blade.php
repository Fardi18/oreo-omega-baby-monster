        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <form class="form-horizontal form-label-left" action="{{ route('admin.config') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            <h2 onclick="$('#x_panel-collapse-main_config').click()" style="cursor: pointer;">{{ ucwords(lang('main configuration', $translations)) }}</h2>
                            <ul class="nav navbar-right panel_toolbox">
                                <li style="float: right !important;"><a class="collapse-link" id="x_panel-collapse-main_config"><i class="fa fa-chevron-up"></i></a></li>
                            </ul>
                            <div class="clearfix"></div>
                        </div>
                        <div class="x_content">
                            @php
                                ...
                                $defined_data = ['logo with app name', 'logo only'];
                                $config = new \stdClass();
                                $config->defined_data = $defined_data;
                                // $config->placeholder = '- '.ucwords(lang('please choose one', $translations)).' -';
                                echo set_input_form('select', 'app_logo_style', ucwords(lang('application logo style', $translations)), $data, $errors, true, $config);

                                $defined_data = ['animated', 'default'];
                                $config = new \stdClass();
                                $config->defined_data = $defined_data;
                                // $config->placeholder = '- '.ucwords(lang('please choose one', $translations)).' -';
                                echo set_input_form('select', 'login_page_style', ucwords(lang('login page style', $translations)), $data, $errors, true, $config);
                                
                                $skins = ['default','festive_yellow', 'feminine_purple', 'racing_red', 'calm_blue', 'simple_black', 'manly_maroon', 'clean_blue', 'confidence_blue'];
                                $defined_data_skins = [];
                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            <h2 onclick="$('#x_panel-collapse-seo_config').click()" style="cursor: pointer;">{{ ucwords(lang('SEO configuration', $translations)) }}</h2>
                            <ul class="nav navbar-right panel_toolbox">
                                <li style="float: right !important;"><a class="collapse-link" id="x_panel-collapse-seo_config"><i class="fa fa-chevron-down"></i></a></li>
                            </ul>
                            <div class="clearfix"></div>
                        </div>
                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            <h2 onclick="$('#x_panel-collapse-security').click()" style="cursor: pointer;">{{ ucwords(lang('security settings', $translations)) }}</h2>
                            <ul class="nav navbar-right panel_toolbox">
                                <li style="float: right !important;"><a class="collapse-link" id="x_panel-collapse-security"><i class="fa fa-chevron-down"></i></a></li>
                            </ul>
                            <div class="clearfix"></div>
                        </div>
                        <div class="x_content" style="display: none;">
                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            <h2 onclick="$('#x_panel-collapse-bg_images').click()" style="cursor: pointer;">{{ ucwords(lang('background images', $translations)) }}</h2>
                            <ul class="nav navbar-right panel_toolbox">
                                <li style="float: right !important;"><a class="collapse-link" id="x_panel-collapse-bg_images"><i class="fa fa-chevron-down"></i></a></li>
                            </ul>
                            <div class="clearfix"></div>
                        </div>
                        <div class="x_content" style="display: none;">
                            @php
                                ...
                                if (empty($data->bg_img_login)) {
                                    $config->value = 'images/background.jpg';
                                }
                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            <h2 onclick="$('#x_panel-collapse-scripts').click()" style="cursor: pointer;">{{ ucwords(lang('add scripts', $translations)) }}</h2>
                            <ul class="nav navbar-right panel_toolbox">
                                <li style="float: right !important;"><a class="collapse-link" id="x_panel-collapse-scripts"><i class="fa fa-chevron-down"></i></a></li>
                            </ul>
                            <div class="clearfix"></div>
                        </div>
                        <div class="x_content" style="display: none;">
