            ...
            html += '<div class="panel-body">';
                ...
                html += '<div class="form-group">';
                    ...
                    html += '<div class="col-md-6 col-sm-6 col-xs-12">';
                        ...
                        html += '<input type="file" name="v_page_element_image[' + section_page_id + '][' + uniqid + '][' + identifier + ']" ' + is_required + ' class="form-control col-md-7 col-xs-12" accept=".jpg, .jpeg, .png, .gif, .webp, .avif" onchange="display_img_input(this, \'before\');" style="margin-top:5px">';
                ...
                html += '<div class="form-group">';
                    ...
                    html += '<div class="col-md-6 col-sm-6 col-xs-12">';
                        ...
                        html += '<input type="file" name="v_page_element_image_mobile[' + section_page_id + '][' + uniqid + '][' + identifier + ']" ' + is_required + ' class="form-control col-md-7 col-xs-12" accept=".jpg, .jpeg, .png, .gif, .webp, .avif" onchange="display_img_input(this, \'before\');" style="margin-top:5px">';
        ...
        html += '<div id="collapse' + uniqid + '" class="panel-collapse collapse in" role="tabpanel">';
            ...
            html += '<div class="panel-body">';
                ...
                html += '<div class="form-group page-element-imagetextbutton-'+uniqid+'-'+i+'">';
                    ...
                    html += '<div class="col-md-6 col-sm-6 col-xs-12">';
                        html += '<img src="' + v_page_element_image + '" class="pagebuilder-content-image">';
                        html += '<input type="file" name="v_page_element_image[' + section_page_id + '][' + uniqid + '][]" class="form-control col-md-7 col-xs-12" accept=".jpg, .jpeg, .png, .gif, .webp, .avif" onchange="display_img_input(this, \'before\');" style="margin-top:5px">';
