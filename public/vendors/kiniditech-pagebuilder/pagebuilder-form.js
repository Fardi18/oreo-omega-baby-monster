...
if (typeof pagebuilder_form_uploaded_path == "undefined") {
    var pagebuilder_form_uploaded_path = "";
}

// SET DEFAULT STATUS USING RICHTEXT FOR QUESTION TEXT
if (typeof pagebuilder_form_question_text_using_richtext == "undefined") {
    var pagebuilder_form_question_text_using_richtext = false;
}

// SET DEFAULT STATUS USING RICHTEXT FOR OPTION TEXT
if (typeof pagebuilder_form_option_text_using_richtext == "undefined") {
    var pagebuilder_form_option_text_using_richtext = false;
}

// SET DEFAULT STATUS USING OPTION RESPONSE WORDING
if (typeof pagebuilder_form_option_response_wording == "undefined") {
    var pagebuilder_form_option_response_wording = false;
}

// SET DEFAULT STATUS USING RICHTEXT FOR OPTION RESPONSE WORDING
if (typeof pagebuilder_form_option_response_wording_using_richtext == "undefined") {
    var pagebuilder_form_option_response_wording_using_richtext = false;
}

// SET DEFAULT STATUS USING QUESTION MEDIA
if (typeof pagebuilder_form_question_media == "undefined") {
    var pagebuilder_form_question_media = false;
}

// SET DEFAULT STATUS FOR ENABLE REQUIRED STATUS
if (typeof pagebuilder_form_enable_required_status == "undefined") {
    var pagebuilder_form_enable_required_status = false;
}

// SET DEFAULT TOTAL OPTIONS
if (typeof pagebuilder_form_total_options == "undefined") {
    var pagebuilder_form_total_options = 4;
}
...
function add_question(
    ...
    if (data != "") {
        ...
        if (pagebuilder_form_question_text_using_richtext) {
    ...
    if (collapsed) {
        ...
        html += '<div id="collapse_form_item_' + identifier + '" class="panel-collapse collapse in" role="tabpanel">';
            ...
            html += '<div class="panel-body">';
                ...
                if (pagebuilder_form_response_wording) {
                    // v_response_wording
                    html += '<div class="form-group">';
                ...
                if (pagebuilder_form_question_media) {
                    // v_question_media
                    html += '<div class="form-group">';
                        html += '<label class="control-label col-md-3 col-sm-3 col-xs-12">Question Media</label>';
                        html += '<div class="col-md-6 col-sm-6 col-xs-12">';
                            html += '<select name="v_question_media[' + identifier + ']" class="form-control col-md-7 col-xs-12" onchange="show_media_question(' + identifier + ', this.value)">';
                    ...
                    var v_question_src_image_preview = v_question_src_image;
                    var show_input_image = '';
                    if (v_question_src_image == '') {
                        v_question_src_image_preview = pagebuilder_no_img;
                        show_input_image = 'display:none;';
                    }
                    html += '<div class="form-group question_src-' + identifier + '" id="question_src-image-' + identifier + '" style="'+show_input_image+'">';
                        html += '<label class="control-label col-md-3 col-sm-3 col-xs-12">Image</label>';
                        html += '<div class="col-md-6 col-sm-6 col-xs-12">';
                            html += '<img src="'+v_question_src_image_preview+'" id="v_question_src_image_preview-' + identifier + '" style="max-width: 200px;max-height: 200px;display: block;">';
                            ...
                            html += '<input type="hidden" name="v_question_src_image_exist[' + identifier + ']" value="'+v_question_src_image+'">';
                        html += '</div>';
                    html += '</div>';
                ...
                if (form_type == 'quiz') {
                    // v_point_per_item
                    html += '<div class="form-group">';
                        html += '<label class="control-label col-md-3 col-sm-3 col-xs-12">Point Per Question <span class="required">*</span></label>';
                        html += '<div class="col-md-6 col-sm-6 col-xs-12">';
                            html += '<input type="number" name="v_point_per_item[' + identifier + ']" min="0" class="form-control col-md-7 col-xs-12" placeholder="input this if want to set point per question" value="' + v_point_per_item + '">';
                        html += '</div>';
                    html += '</div>';
                }

                if (pagebuilder_form_enable_required_status) {
                    // v_is_required
                    html += '<div class="form-group">';
...
function generate_html_options_text(form_type, options_text, option_answer_index, collapsed, identifier) {
    ...
    if (options_text != '') {
        ...
        for (let index = 0; index < pagebuilder_form_total_options; index++) {
            var answer_icon_style = 'display:none;';
            if (form_type == 'quiz') {
                if (index == option_answer_index) {
                    answer_icon_style = '';
...
function show_media_question(identifier, the_value) {
    $('#question_src-image-'+identifier).hide();
    $('#question_src-video-'+identifier).hide();
    if (the_value == 'image') {
        $('#question_src-image-'+identifier).show();
    } else if (the_value == 'video') {
        $('#question_src-video-'+identifier).show();
    }
}