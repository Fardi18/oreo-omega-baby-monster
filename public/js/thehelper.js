...
function set_param_url(key, value) {
    ...
    if (value == "") {
        if (typeof URLSearchParams !== 'undefined') {
            ...
            if (typeof params !== 'undefined') {
                result = url.origin+url.pathname+"?"+params.toString();
            } else {
    ...
    var final_uri_segments = result;
    if (typeof arr_uri[1] !== 'undefined') {
        final_uri_segments = "?" + arr_uri[1];
    }
    if (final_uri_segments == "?") {
        final_uri_segments = arr_uri[0];
    }
